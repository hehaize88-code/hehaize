    ...
    <article className="product-card">
      ...
      <div className="product-body">
        ...
        <div className="product-footer">
          ...
          <a className="product-button" href={product.storeUrl} rel="nofollow" data-track-event="category_outbound_click" data-item-category={product.category} data-click-area="product-card-button">Browse category <span aria-hidden="true">↗</span></a>
        </div>
      </div>
    </article>
  );
