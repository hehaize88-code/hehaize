  ...
  return (
    <main className="home-page">
      ...
      <section className="section guide-section">
        ...
        {locale === "en" ? <a className="article-crosslink" href="/articles/cssbuy-taobao-finds-compare-listings"><span>NEW ARTICLE</span>Compare Taobao listings before ordering <ArrowIcon /></a> : null}
      </section>
