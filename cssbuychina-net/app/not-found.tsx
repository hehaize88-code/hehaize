  ...
  return (
    <InnerShell>
      <section className="not-found-page">
        ...
        <div><a href="/products">Browse checked finds</a><a href="https://www.cnbuycha.com/AllProducts/" rel="nofollow" data-track-event="category_outbound_click" data-item-category="all" data-click-area="not-found">Open full catalog ↗</a></div>
      </section>
    </InnerShell>
  );
}
