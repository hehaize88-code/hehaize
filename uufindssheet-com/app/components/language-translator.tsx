...
const german: Record<string, string> = {
  ...
  "Research a product with UUFinds, check available QC material, then browse the matching category on the main site.": "Recherchiere ein Produkt mit UUFinds, prüfe verfügbares QC-Material und öffne anschließend die passende Kategorie auf der Hauptseite.",
  "Search shoes, hoodies, accessories…": "Schuhe, Hoodies oder Accessoires suchen …",
  "Search main-site products": "Hauptseiten-Produkte durchsuchen",
  ...
  "guide": "Ratgeber",
  "Direct the main site": "Direkte Hauptseite",
  "Sheet links": "Sheet-Links",
  "Curated routes / 09": "Ausgewählte Wege / 09",
  "Start with a category.": "Beginne mit einer Kategorie.",
  "Each shortcut opens the matching main-site category—not a generic homepage.": "Jeder Direktlink öffnet die passende Kategorie der Hauptseite – nicht eine allgemeine Startseite.",
  "Shoes": "Schuhe",
  ...
  "Keep product discovery, visual checking and destination-page verification as three separate decisions.": "Behandle Produktsuche, visuelle Prüfung und Kontrolle der Hauptseite als drei getrennte Entscheidungen.",
  ...
  "BROWSE": "DURCHSUCHEN",
  "Continue on the main site": "Bei Hauptseite fortfahren",
  ...
  "A complete reverse-shopping workflow for researching evidence, comparing listings and continuing to the right main-site product page.": "Ein vollständiger Reverse-Shopping-Ablauf zum Prüfen von Hinweisen, Vergleichen von Angeboten und Öffnen der richtigen Produktseite der Hauptseite.",
  ...
  "How to use UUFinds and continue browsing on the main site": "UUFinds nutzen und auf der Hauptseite weitersuchen",
  ...
  "UUFinds Sheet is an editorial guide and routing site. We do not claim to be UUFinds, do not sell products and do not process orders. All outbound search, category and product routes on this site lead only to the main site.": "UUFinds Sheet ist ein redaktioneller Ratgeber und eine Weiterleitungsseite. Wir sind nicht UUFinds, verkaufen keine Produkte und bearbeiten keine Bestellungen. Alle externen Such-, Kategorie- und Produktlinks führen ausschließlich zur Hauptseite.",
  ...
  "Why do the category links open the main site?": "Warum öffnen die Kategorielinks Hauptseite?",
  "Can I search with a product name?": "Kann ich mit einem Produktnamen suchen?",
  "What should I re-check on the destination page?": "Was sollte ich auf der Hauptseite erneut prüfen?",
  "Independent educational guide. Not affiliated with, endorsed by, or operated by UUFinds. All outbound shopping links lead only to the main site.": "Unabhängiger Bildungsratgeber. Nicht mit UUFinds verbunden, von UUFinds empfohlen oder betrieben. Alle externen Shopping-Links führen ausschließlich zur Hauptseite.",
...
const polish: Record<string, string> = {
  ...
  "Research a product with UUFinds, check available QC material, then browse the matching category on the main site.": "Sprawdź produkt w UUFinds, przejrzyj dostępne materiały QC, a następnie otwórz odpowiednią kategorię w serwisie głównym.",
  "Search shoes, hoodies, accessories…": "Szukaj butów, bluz lub akcesoriów…",
  "Search main-site products": "Szukaj produktów w serwisie głównym",
  ...
  "guide": "poradnik",
  "Direct the main site": "Bezpośrednie linki",
  "Sheet links": "serwis główny",
  "Curated routes / 09": "Wybrane trasy / 09",
  "Start with a category.": "Zacznij od kategorii.",
  "Each shortcut opens the matching main-site category—not a generic homepage.": "Każdy skrót otwiera odpowiednią kategorię serwis główny, a nie ogólną stronę główną.",
  "Shoes": "Buty",
  ...
  "Each find has its own page here, followed by one direct button to the exact main-site product.": "Każdy produkt ma tutaj własną stronę i bezpośredni przycisk do dokładnej oferty w serwisie głównym.",
  ...
  "BROWSE": "PRZEGLĄDAJ",
  "Continue on the main site": "Kontynuuj w serwisie głównym",
  ...
  "A complete reverse-shopping workflow for researching evidence, comparing listings and continuing to the right main-site product page.": "Pełny proces reverse shoppingu: analiza materiałów, porównywanie ofert i przejście do właściwej strony produktu serwis główny.",
  "QC METHOD": "METODA QC",
  ...
  "How to use UUFinds and continue browsing on the main site": "Jak korzystać z UUFinds i kontynuować przeglądanie w serwisie głównym",
  ...
  "Why do the category links open the main site?": "Dlaczego linki kategorii otwierają serwis główny?",
  ...
  "Independent educational guide. Not affiliated with, endorsed by, or operated by UUFinds. All outbound shopping links lead only to the main site.": "Niezależny przewodnik edukacyjny. Nie jest powiązany, wspierany ani prowadzony przez UUFinds. Wszystkie zewnętrzne linki zakupowe prowadzą wyłącznie do serwisu głównego.",
...
const portuguese: Record<string, string> = {
  ...
  "Research a product with UUFinds, check available QC material, then browse the matching category on the main site.": "Pesquise um produto no UUFinds, confira os materiais de QC disponíveis e depois abra a categoria correspondente no site principal.",
  "Search shoes, hoodies, accessories…": "Buscar tênis, moletons ou acessórios…",
  "Search main-site products": "Buscar produtos no site principal",
  ...
  "guide": "guia",
  "Direct the main site": "Links diretos",
  "Sheet links": "do site principal",
  "Curated routes / 09": "Rotas selecionadas / 09",
  "Start with a category.": "Comece por uma categoria.",
  "Each shortcut opens the matching main-site category—not a generic homepage.": "Cada atalho abre a categoria correspondente no site principal, e não uma página inicial genérica.",
  "Shoes": "Tênis",
  ...
  "Each find has its own page here, followed by one direct button to the exact main-site product.": "Cada produto tem uma página própria aqui e um botão direto para a oferta exata no site principal.",
  ...
  "BROWSE": "EXPLORAR",
  "Continue on the main site": "Continue no site principal",
  ...
  "A complete reverse-shopping workflow for researching evidence, comparing listings and continuing to the right main-site product page.": "Um processo completo de compra reversa para analisar evidências, comparar anúncios e abrir a página correta do produto no site principal.",
  ...
  "How to use UUFinds and continue browsing on the main site": "Como usar o UUFinds e continuar explorando no site principal",
  ...
  "Why do the category links open the main site?": "Por que os links de categoria abrem o site principal?",
  ...
  "Independent educational guide. Not affiliated with, endorsed by, or operated by UUFinds. All outbound shopping links lead only to the main site.": "Guia educacional independente. Não é afiliado, apoiado nem operado pelo UUFinds. Todos os links externos de compra levam somente ao site principal.",
