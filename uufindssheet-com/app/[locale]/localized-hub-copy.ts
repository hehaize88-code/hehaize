  ...
  "en-gb": {
    finds: {
      ...
      evidenceCards: [
        ...
        { label: "EXACT PRODUCT", title: "Useful for the final match", body: "Open an individual main-site detail page and compare its product ID, images, price and variants with the item you researched.", note: "Use the live page for current facts that a shared find cannot preserve." },
      ],
      ...
      checklist: [
        ...
        { lead: "Finish live:", body: "confirm today’s information on the exact main-site product page." },
      ],
      sourceLabel: "Source boundary / Reviewed July 23, 2026",
      sourceBody: "Function claims on this page were checked against UUFinds’ public QC finder, QC browsing page, personalised display page, product disclaimer and app information. Category and shopping buttons remain exclusive to the main site.",
      categoryNotes: {
    ...
    how: {
      ...
      workflow: [
        ...
        { label: "CONFIRM", title: "Check today’s listing facts", body: "Open the exact main-site product page and re-check the identifier, current price, variants, size information and availability. An older QC set can inform the decision, but it cannot confirm what the seller offers today.", link: "Open product details" },
      ],
      ...
      checklist: [
        ...
        { lead: "Live check:", body: "current ID, price, variants and availability on the main site." },
  ...
  de: {
    finds: {
      ...
      evidenceCards: [
        ...
        { label: "EXAKTES PRODUKT", title: "Nützlich für die endgültige Zuordnung", body: "Öffne eine einzelne Detailseite der Hauptseite und vergleiche Produkt-ID, Bilder, Preis und Varianten mit dem recherchierten Artikel.", note: "Nutze die Live-Seite für aktuelle Fakten, die eine geteilte Fundseite nicht bewahren kann." },
      ],
      ...
      checklist: [
        ...
        { lead: "Live abschließen:", body: "heutige Angaben auf der exakten Produktseite der Hauptseite bestätigen." },
      ],
      sourceLabel: "Quellengrenze / Geprüft am 23. Juli 2026",
      sourceBody: "Die Funktionsangaben dieser Seite wurden mit dem öffentlichen UUFinds-QC-Finder, der QC-Übersicht, der personalisierten Anzeigeseite, dem Produkthinweis und den App-Informationen abgeglichen. Kategorie- und Einkaufsbuttons führen ausschließlich zur Hauptseite.",
      categoryNotes: {
    ...
    how: {
      ...
      workflow: [
        ...
        { label: "BESTÄTIGEN", title: "Heutige Angebotsdaten prüfen", body: "Öffne die exakte Produktseite der Hauptseite und prüfe Kennung, aktuellen Preis, Varianten, Größenangaben und Verfügbarkeit erneut. Ein älteres QC-Set kann informieren, aber nicht bestätigen, was der Verkäufer heute anbietet.", link: "Produktdetails öffnen" },
      ],
      ...
      matrix: [
        ...
        { label: "LIVE-PRODUKTSEITE", title: "Nützlich für aktuelle Fakten", body: "Auf der Hauptseite müssen Preis, verfügbare Optionen, Verkäuferangaben und Bestand erneut geprüft werden.", note: "Auch sie verspricht nicht, dass jeder erhaltene Artikel einem älteren Muster entspricht." },
      ],
      ...
      checklist: [
        ...
        { lead: "Live-Prüfung:", body: "aktuelle ID, Preis, Varianten und Verfügbarkeit auf der Hauptseite." },
  ...
  pl: {
    finds: {
      ...
      evidenceCards: [
        ...
        { label: "DOKŁADNY PRODUKT", title: "Przydatny do końcowego dopasowania", body: "Otwórz indywidualną stronę szczegółów serwisie głównym i porównaj ID produktu, zdjęcia, cenę oraz warianty z badanym przedmiotem.", note: "Aktualne fakty sprawdzaj na stronie na żywo, ponieważ udostępnione znalezisko ich nie zachowuje." },
      ],
      ...
      checklist: [
        ...
        { lead: "Zakończ na żywo:", body: "potwierdź dzisiejsze dane na dokładnej stronie produktu w serwisie głównym." },
      ],
      sourceLabel: "Granica źródeł / Sprawdzono 23 lipca 2026",
      sourceBody: "Informacje o funkcjach na tej stronie sprawdzono na publicznej wyszukiwarce QC UUFinds, stronie przeglądania QC, spersonalizowanej stronie prezentacji, zastrzeżeniu produktu i w informacjach o aplikacji. Przyciski kategorii i zakupów prowadzą wyłącznie do serwisu głównego.",
      categoryNotes: {
    ...
    how: {
      ...
      checklist: [
        ...
        { lead: "Kontrola na żywo:", body: "aktualne ID, cena, warianty i dostępność w serwisie głównym." },
  ...
  "pt-br": {
    finds: {
      ...
      evidenceCards: [
        ...
        { label: "PRODUTO EXATO", title: "Útil para a relação final", body: "Abra uma página individual de detalhes no site principal e compare ID, imagens, preço e variantes com o item pesquisado.", note: "Use a página ativa para fatos atuais que um achado compartilhado não consegue preservar." },
      ],
      ...
      checklist: [
        ...
        { lead: "Finalize ao vivo:", body: "confirme os dados de hoje na página exata do produto no site principal." },
      ],
      sourceLabel: "Limite das fontes / Revisado em 23 de julho de 2026",
      sourceBody: "As afirmações sobre funções desta página foram conferidas no localizador público de QC do UUFinds, na página de navegação de QC, na página de apresentação personalizada, no aviso de produto e nas informações do aplicativo. Os botões de categoria e compra continuam exclusivos do site principal.",
      categoryNotes: {
    ...
    how: {
      ...
      workflow: [
        ...
        { label: "CONFIRME", title: "Confira os dados atuais do anúncio", body: "Abra a página exata do produto no site principal e verifique novamente identificador, preço atual, variantes, tamanhos e disponibilidade. Um conjunto antigo de QC ajuda na decisão, mas não confirma o que o vendedor oferece hoje.", link: "Abra os detalhes do produto" },
      ],
      ...
      checklist: [
        ...
        { lead: "Verificação ao vivo:", body: "ID, preço, variantes e disponibilidade atuais no site principal." },
