...
export const catalogCopies: Record<Locale, CatalogCopy> = {
  en: {
    homeSeoTitle: "KameyMall Spreadsheet 2026: 30 Finds, Prices & Direct Links",
    ...
    categoryIntro: "Three checked product entries from this category. Every product image, name and action opens its matching live listing directly.",
    ...
    categoryMeta: "Browse three checked {category} finds with source prices, product references and direct links to matching live listings.",
  },
  de: {
    homeSeoTitle: "KameyMall-Tabelle 2026: 30 Funde, Preise & direkte Links",
    ...
    categoryIntro: "Drei geprüfte Produkte dieser Kategorie. Produktbild, Name und Aktion öffnen direkt das passende Live-Angebot.",
    ...
    categoryMeta: "Drei geprüfte {category}-Fundstücke mit Quellpreisen, Produktreferenzen und direkten Links zu passenden Live-Angeboten.",
  },
  fr: {
    homeSeoTitle: "Tableur KameyMall 2026 : 30 produits, prix et liens directs",
    ...
    categoryIntro: "Trois produits vérifiés de cette catégorie. L’image, le nom et l’action ouvrent directement la fiche en direct correspondante.",
    ...
    categoryMeta: "Trois trouvailles {category} vérifiées avec prix source, références et liens directs vers les fiches correspondantes.",
  },
  es: {
    homeSeoTitle: "Hoja KameyMall 2026: 30 productos, precios y enlaces directos",
    ...
    categoryIntro: "Tres productos comprobados de esta categoría. La imagen, el nombre y la acción abren directamente el listado correspondiente.",
    ...
    categoryMeta: "Tres hallazgos de {category} comprobados con precios fuente, referencias y enlaces directos a los listados correspondientes.",
  },
  it: {
    homeSeoTitle: "Foglio KameyMall 2026: 30 prodotti, prezzi e link diretti",
    ...
    categoryIntro: "Tre prodotti verificati di questa categoria. Immagine, nome e azione aprono direttamente l’inserzione live corrispondente.",
    ...
    categoryMeta: "Tre prodotti {category} verificati con prezzi fonte, riferimenti e link diretti alle inserzioni corrispondenti.",
  },
  pl: {
    homeSeoTitle: "Arkusz KameyMall 2026: 30 produktów, ceny i bezpośrednie linki",
    ...
    categoryIntro: "Trzy sprawdzone produkty z tej kategorii. Obraz, nazwa i przycisk otwierają bezpośrednio właściwą aktywną ofertę.",
    ...
    categoryMeta: "Trzy sprawdzone produkty {category} z cenami źródłowymi, numerami i bezpośrednimi linkami do właściwych ofert.",
  },
};
