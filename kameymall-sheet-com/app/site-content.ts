...
const english: SiteCopy = {
  nav: { finds: "Finds", categories: "Categories", how: "How to Buy", guides: "Guides", articles: "Buying Guides", faq: "FAQ" },
  language: "Language",
  home: {
    eyebrow: "Independent KameyMall shopping guide · Updated Sep 2026",
  ...
  articles: {
    kicker: "Independent buying guide library",
  ...
  common: {
    ...
    backToArticles: "Back to buying guides",
...
german.nav = { finds: "Fundstücke", categories: "Kategorien", how: "So kaufst du", guides: "Ratgeber", articles: "Kaufratgeber", faq: "FAQ" };
german.language = "Sprache";
german.home = { eyebrow: "Unabhängiger KameyMall-Einkaufsratgeber · Aktualisiert Sept. 2026", title: "KameyMall-Tabelle 2026: 30 kuratierte Produktfunde", lede: "Entdecke 30 kuratierte KameyMall-Tabellenfunde aus Schuhen, Hoodies, Trikots und Accessoires. Vergleiche Preise, nutze den QC-Ratgeber und öffne die exakten Produktseiten.", searchPlaceholder: "30 kuratierte China-Fundstücke durchsuchen", searchLabel: "Haupt-Produktdatenbank durchsuchen", explore: "Empfohlene Fundstücke", howAction: "So funktioniert es", categoriesCount: "Kategorien", findsCount: "Produktfundstücke", direct: "Direkt", listingPages: "zu Produktseiten" };
...
german.articles = { kicker: "Unabhängige Kaufratgeber", title: "Recherchebasierte KameyMall-Artikel", intro: "Originale Ratgeber zu China-Fundstücken, Angebotsprüfung, Lagerkontrolle und grenzüberschreitender Kostenplanung.", read: "Artikel lesen", cards: [
...
french.articles = { kicker: "Bibliothèque de guides d’achat", title: "Articles KameyMall fondés sur la recherche", intro: "Guides originaux sur les trouvailles chinoises, la vérification, l’entrepôt et la planification des coûts transfrontaliers.", read: "Lire l’article", cards: [
...
spanish.articles = { kicker: "Biblioteca de guías de compra", title: "Artículos KameyMall basados en investigación", intro: "Guías originales sobre hallazgos chinos, verificación, almacén y planificación transfronteriza.", read: "Leer artículo", cards: [
...
italian.articles = { kicker: "Biblioteca di guide all’acquisto", title: "Articoli KameyMall basati sulla ricerca", intro: "Guide originali su prodotti cinesi, verifica, magazzino e pianificazione dei costi internazionali.", read: "Leggi articolo", cards: [
...
polish.articles = { kicker: "Biblioteka poradników zakupowych", title: "Artykuły KameyMall oparte na analizie", intro: "Oryginalne poradniki o chińskich produktach, weryfikacji, magazynie i kosztach międzynarodowych.", read: "Czytaj artykuł", cards: [
...
const localizedPageIntros: Record<Locale, Partial<SiteCopy["pageIntros"]>> = {
  ...
  de: {
    ...
    articles: { kicker: "Bibliothek für Kaufratgeber", title: "Reverse-Shopping-Recherche für Käufer im Ausland", intro: "Originale Langformartikel zu Suche, Prüfung, Kosten, Lager und Lieferung." },
  },
  fr: {
    ...
    articles: { kicker: "Bibliothèque de guides d’achat", title: "Recherche de reverse shopping pour acheteurs internationaux", intro: "Articles originaux sur découverte, vérification, coûts, entrepôt et livraison." },
  },
  es: {
    ...
    articles: { kicker: "Biblioteca de guías de compra", title: "Investigación de compra inversa para compradores internacionales", intro: "Artículos originales sobre búsqueda, verificación, costes, almacén y entrega." },
  },
  it: {
    ...
    articles: { kicker: "Biblioteca di guide all’acquisto", title: "Ricerca reverse shopping per acquirenti internazionali", intro: "Articoli originali su scoperta, verifica, costi, magazzino e consegna." },
  },
  pl: {
    ...
    articles: { kicker: "Biblioteka poradników zakupowych", title: "Analizy zakupów odwrotnych dla kupujących za granicą", intro: "Oryginalne artykuły o wyszukiwaniu, kontroli, kosztach, magazynie i dostawie." },
  },
};
...
const researchUiUpdates: Partial<Record<Locale, ResearchUiUpdate>> = {
  de: {
    ...
    articles: { kicker: "Unabhängige Kaufratgeber", title: "Faktengeprüfte KameyMall-Artikel", intro: "Originale Langformtexte für Suche, Einkaufsablauf und Kostenplanung, mit klarer Trennung zwischen Plattformangaben und Nutzerberichten.", read: "Artikel lesen", cards: [
  ...
  fr: {
    ...
    articles: { kicker: "Bibliothèque de guides d’achat", title: "Articles KameyMall vérifiés", intro: "Des articles originaux sur la recherche, le parcours et les coûts, distinguant déclarations officielles et témoignages.", read: "Lire l’article", cards: [
  ...
  es: {
    ...
    articles: { kicker: "Biblioteca de guías de compra", title: "Artículos KameyMall verificados", intro: "Textos originales sobre búsqueda, proceso y costes, separando declaraciones de plataforma y experiencias de usuarios.", read: "Leer artículo", cards: [
  ...
  it: {
    ...
    articles: { kicker: "Biblioteca di guide all’acquisto", title: "Articoli KameyMall verificati", intro: "Testi originali su ricerca, processo e costi, distinguendo dichiarazioni della piattaforma e testimonianze.", read: "Leggi articolo", cards: [
  ...
  pl: {
    ...
    articles: { kicker: "Biblioteka poradników zakupowych", title: "Zweryfikowane artykuły KameyMall", intro: "Oryginalne treści o wyszukiwaniu, procesie i kosztach z rozróżnieniem deklaracji platformy i opinii użytkowników.", read: "Czytaj artykuł", cards: [
