...
const templates: Record<Locale, Template> = {
  en: {
    ...
    productsIntro: "Open the matching current product directly, then confirm its option, price and availability before ordering.",
  ...
  de: {
    ...
    productsIntro: "Das passende aktuelle Produkt direkt öffnen und Auswahl, Preis sowie Verfügbarkeit prüfen.",
