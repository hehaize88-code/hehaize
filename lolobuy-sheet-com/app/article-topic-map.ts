...
export const articleTopicMap: ArticleTopicMapEntry[] = [
  ...
  {
    url: "/articles/lolobuy-product-link-not-working",
    primaryQuery: "lolobuy link not working",
    relatedTerms: ["lolobuy product link invalid", "weidian link not working lolobuy", "recover taobao 1688 link"],
    intent: "problem solving",
    angle: "Classify parser and seller-page failures, recover stable identifiers and re-verify the exact variant.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Current seller listing fields", "Lolobuy Sheet recovery framework"],
    internalLinkRole: "Dead-link recovery bridge between discovery, seller checks and marketplace-specific guides.",
  },
  {
    url: "/articles/lolobuy-image-search-guide",
    primaryQuery: "lolobuy image search",
    relatedTerms: ["find lolobuy product from image", "reverse image search china products", "photo to product link"],
    intent: "problem solving",
    angle: "Use image matching to create candidates, then verify specifications and selected options before ordering.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Live seller listings", "Lolobuy Sheet image-search framework"],
    internalLinkRole: "Image-led recovery path into keyword search, seller checks and link verification.",
  },
  {
    url: "/articles/lolobuy-order-status-guide",
    primaryQuery: "lolobuy order status",
    relatedTerms: ["lolobuy seller sent", "lolobuy stored status", "lolobuy order shipped"],
    intent: "problem solving",
    angle: "Separate seller, warehouse, parcel and carrier clocks so delays are escalated with stage-specific evidence.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Current order and parcel records", "Lolobuy Sheet status framework"],
    internalLinkRole: "Lifecycle hub joining ordering, warehouse remedies, parcel planning and tracking.",
  },
  {
    url: "/articles/lolobuy-fees-explained",
    primaryQuery: "lolobuy fees",
    relatedTerms: ["lolobuy service fee", "lolobuy total cost", "lolobuy shipping payment"],
    intent: "commercial investigation",
    angle: "Build a confirmed-versus-estimated ledger without inventing a permanent fee percentage.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Official LoloBuy app listing", "Live payment and parcel screens"],
    internalLinkRole: "Cost hub connecting product selection, payment, warehouse services and final parcel planning.",
  },
  {
    url: "/articles/lolobuy-payment-guide",
    primaryQuery: "how to pay on lolobuy",
    relatedTerms: ["lolobuy payment", "lolobuy second payment", "lolobuy shipping payment"],
    intent: "problem solving",
    angle: "Separate source-order and international-parcel payments and reconcile each live transaction safely.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Official LoloBuy app listing", "Current checkout records"],
    internalLinkRole: "Payment-control path from order creation through adjustments to the prepared parcel.",
  },
  {
    url: "/articles/lolobuy-return-refund-guide",
    primaryQuery: "lolobuy refund",
    relatedTerms: ["lolobuy return", "return item after qc lolobuy", "lolobuy refund status"],
    intent: "problem solving",
    angle: "Build an objective mismatch file and verify the order-specific action before international shipping.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Current seller and order records", "Lolobuy Sheet remedy framework"],
    internalLinkRole: "Warehouse remedy hub linking QC evidence, targeted inspection and status tracking.",
  },
  {
    url: "/articles/lolobuy-extra-qc-photos-measurements",
    primaryQuery: "lolobuy extra qc photos",
    relatedTerms: ["lolobuy measurement photo", "request warehouse photos", "lolobuy insole measurement"],
    intent: "problem solving",
    angle: "Design one decision-changing image or measurement request without assuming availability or price.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Current warehouse order options", "Lolobuy Sheet evidence framework"],
    internalLinkRole: "Targeted evidence path between general QC review and return or acceptance decisions.",
  },
  {
    url: "/articles/lolobuy-restricted-items-shipping-routes",
    primaryQuery: "lolobuy restricted items",
    relatedTerms: ["lolobuy shipping restrictions", "lolobuy shipping route unavailable", "restricted item parcel checklist"],
    intent: "problem solving",
    angle: "Screen item attributes, destination rules and final parcel combinations before selecting a live eligible route.",
    evidence: ["LoloBuy public website checked September 15, 2026", "Current product and parcel records", "Authoritative destination and carrier rules"],
    internalLinkRole: "Pre-parcel risk gate connecting product facts, consolidation, cost and route choice.",
  },
];
