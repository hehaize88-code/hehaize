...
const slug = "joyagoo-shipping-to-usa-cost-planner";
const entry = getSeoArticleEntry("en", slug)!;

export const metadata: Metadata = {
  title: { absolute: "Joyagoo Shipping to USA: Cost & Weight Planner 2026" },
...
export default function JoyagooUsaShippingCostPage() {
