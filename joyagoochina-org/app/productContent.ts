...
export const productPageCopy: Record<Locale, ProductPageCopy> = {
  en: {
    ...
    overviewBody:
      "The name, product ID, source price and image on this page were matched to the linked product listing on the checked date. Open the live listing before paying because stock, variants, seller notes and price can change.",
  ...
  zh: {
    ...
    overviewBody:
      "本页商品名、商品ID、来源价格和图片已在标注日期与对应的来源商品页逐项核对。付款前仍应打开实时页面，因为库存、规格、卖家说明和价格可能变化。",
    qcTitle: "确认收货前的质检重点",
    qcIntro:
  ...
  de: {
    ...
    overviewBody:
      "Name, Produkt-ID, Ausgangspreis und Bild wurden am Prüftag mit dem verlinkten Produktangebot abgeglichen. Vor der Zahlung das Live-Angebot öffnen, da Bestand, Varianten, Verkäuferhinweise und Preis wechseln können.",
  ...
  pl: {
    ...
    overviewBody:
      "Nazwa, ID, cena źródłowa i zdjęcie zostały porównane z podaną ofertą produktu w dniu kontroli. Przed płatnością otwórz aktualną ofertę, ponieważ zapasy, warianty, uwagi i cena mogą się zmienić.",
  ...
  es: {
    ...
    overviewBody:
      "Nombre, ID, precio de origen e imagen se contrastaron con la ficha de producto enlazada en la fecha indicada. Abre la oferta actual antes de pagar porque existencias, variantes, notas y precio pueden cambiar.",
  ...
  it: {
    ...
    overviewBody:
      "Nome, ID, prezzo e immagine sono stati confrontati con l’inserzione prodotto collegata alla data indicata. Prima del pagamento apri la pagina live, perché disponibilità, varianti, note e prezzo possono cambiare.",
  ...
  fr: {
    ...
    overviewBody:
      "Le nom, l’ID, le prix source et l’image ont été comparés à la fiche produit liée à la date indiquée. Ouvrez l’annonce actuelle avant paiement, car stock, variantes, notes et prix peuvent changer.",
  ...
  pt: {
    ...
    overviewBody:
      "Nome, ID, preço e imagem foram comparados com a oferta de produto ligada na data indicada. Abra a página atual antes de pagar, pois stock, variantes, notas e preço podem mudar.",
  ...
  ro: {
    ...
    overviewBody:
      "Numele, ID-ul, prețul și imaginea au fost comparate cu oferta de produs conectată la data indicată. Deschide oferta live înainte de plată deoarece stocul, variantele, notele și prețul se pot schimba.",
  ...
  sv: {
    ...
    overviewBody:
      "Namn, ID, källpris och bild jämfördes med den länkade produktannonsen på angivet datum. Öppna den aktuella sidan före betalning eftersom lager, varianter, anteckningar och pris kan ändras.",
