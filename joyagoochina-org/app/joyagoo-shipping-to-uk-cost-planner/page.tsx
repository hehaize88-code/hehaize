...
const slug = "joyagoo-shipping-to-uk-cost-planner";
const entry = getSeoArticleEntry("en", slug)!;

export const metadata: Metadata = {
  title: { absolute: "Joyagoo Shipping to UK: Cost & Weight Planner 2026" },
...
export default function JoyagooUkShippingCostPage() {
